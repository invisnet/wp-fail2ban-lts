...
class BlockedUsersTest extends TestCase
{
    ...
    public function testRegexBlocked()
    {
        ...
        $this->expectOutputString('5|Blocked authentication attempt for blocked from 255.255.255.255');
    ...
    public function testArrayBlocked()
    {
        ...
        $this->expectOutputString('5|Blocked authentication attempt for b from 255.255.255.255');
